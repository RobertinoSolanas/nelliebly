...
class CalculateRouteControllerTest {
    ...
    void calculateRoute_shouldReturnRouteInformation() {
        webTestClient.get()
                ...
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.start").isEqualTo("New York")
                .jsonPath("$.end").isEqualTo("Boston")
                .jsonPath("$.distance").isEqualTo("5.2 km")
                .jsonPath("$.duration").isEqualTo("15 minutes");
    }
    ...
    void calculateRoute_withStartOnly_shouldReturnBadRequest() {
        webTestClient.get()
                .uri("/calculateRoute?start=New York")
                .exchange()
                .expectStatus().is4xxClientError();
    }
